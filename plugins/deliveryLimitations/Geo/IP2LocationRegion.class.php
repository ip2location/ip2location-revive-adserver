...
class Plugins_DeliveryLimitations_Geo_IP2LocationRegion extends Plugins_DeliveryLimitations_IP2Location_CommaSeparatedData
{
	function __construct()
	{
		parent::__construct();
		$this->columnName = 'geo_IP2Location_region';
		$this->nameEnglish = 'IP2Location - Region';
	}
	...
	function displayData()
	{
		...
		if (!empty($this->data[0])) {
			...
			echo '<tr><th>' . $this->translate('Region(s)') . "&nbsp;&nbsp;</th><td><div class='box'  style= 'width: 325px;'>";
