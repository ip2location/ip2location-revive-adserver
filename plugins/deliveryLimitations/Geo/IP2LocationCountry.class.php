...
class Plugins_DeliveryLimitations_Geo_IP2LocationCountry extends Plugins_DeliveryLimitations_IP2Location_CommaSeparatedData
{
	function __construct()
	{
		parent::__construct();
		$this->columnName = 'geo_IP2Location_country';
		$this->nameEnglish = 'IP2Location - Country';
	}
