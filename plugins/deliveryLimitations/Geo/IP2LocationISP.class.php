...
class Plugins_DeliveryLimitations_Geo_IP2LocationISP extends Plugins_DeliveryLimitations_IP2Location_CommaSeparatedData
{
	function __construct()
	{
		parent::__construct();
		$this->columnName = 'geo_IP2Location_isp';
		$this->nameEnglish = 'IP2Location - ISP';
	}
