...
class Plugins_DeliveryLimitations_Geo_IP2LocationIsProxy extends Plugins_DeliveryLimitations_IP2Location_CommaSeparatedData
{
	function __construct()
	{
		parent::__construct();
		$this->columnName = 'geo_IP2Location_isproxy';
		$this->nameEnglish = 'IP2Location - Is Proxy';
	}
